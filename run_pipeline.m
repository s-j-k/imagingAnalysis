function run_pipeline(sessid, TSer, FOVnum,foldername,filetype)
% % MODIFIED VERSION OF CALMAN run_pipeline  

% % BBS 1/8/21
% % you will need to modify the folder names in STEPS 1-3 for your computer
...
save(['workspace' sessid '-t' TSer '.mat'],'-v7.3');
