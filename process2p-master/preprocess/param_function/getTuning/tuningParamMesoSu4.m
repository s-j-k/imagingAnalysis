...
% nTrials = 12;
nTrials = 10;
nFramesPerTone = 25/nPlanes; % this is the modulus value in TDT
nFramesPerTrial = nFramesPerTone * nTones; % 850
startTrial = 1; % the first tone is on frame 0
nFrames = nFramesPerTrial*nTrials; % 4250
frameRate = 7/nPlanes; % in the future, do not hard code this.
% ----------------- Tone Presentation Protocol ---------------------
pretoneFrames = 10; % this is for visualization
baselineFrames = 5; % this is for the significance test, which is a comparable number of frames to the number 
                    % of frames used to calculate the peak activity 

toneOnset = 11/nPlanes; % this is the compare value in TDT % compare/2 minus 1 for plane 2? 
...
% smoothWindow = 5; 
smoothWindow = 2; 
smoothArg = {'gaussian',smoothWindow};
