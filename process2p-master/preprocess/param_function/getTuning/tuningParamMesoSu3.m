...
nTones = length(tone);
nTrials = 15;
nFramesPerTone = 100/nPlanes; % this is the modulus value in TDT
nFramesPerTrial = nFramesPerTone * nTones; % 850
startTrial = 1; % the first tone is on frame 0
nFrames = nFramesPerTrial*nTrials; % 4250
frameRate = 17/nPlanes; % in the future, do not hard code this.
% ----------------- Tone Presentation Protocol ---------------------
pretoneFrames = 10;
baselineFrames = 5;

toneOnset = 20/nPlanes; % this is the compare value in TDT
