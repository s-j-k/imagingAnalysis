function TC = extractTCfromBin(mouse,channel,grid)
...
%     suite2ppath='X:\sjk\ACMGB_1\sk70\day3\suite2p';
%     sbxpath=['X:\sjk\ACMGB_1\sk70\day3'];
end

% if strcmp(mouse,'sk78')
%     suite2ppath = ['C:\Users\sjkim1\Desktop\scratch\' mouse '\suite2p\'];
% %     sbxpath = ['C:\Users\sjkim1\Desktop\scratch\' mouse  '\'];
%     sbxpath='X:\sjk\ACMGB_1\sk78\testrun\';
% end
...
names = names(1); nFiles=1 ;% take only the second one
